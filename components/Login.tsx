      ...
      <div
        ...
        <div className="grid gap-2 text-center">
          ...
          <button
            ...
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full  px-2 py-1 text-sm font-medium backdrop-blur-3xl backdrop-saturate-150 transition-all duration-200 ease-in-out">
              <BlurIn
                text="Tester sans connexion"
                balise="h1"
                className={` font-bold  bg-gradient-to-r from-gray-500 via-gray-800 to-gray-500 inline-block text-transparent bg-clip-text z-10`}
              />{" "}
            </span>
          </button>
        </div>
